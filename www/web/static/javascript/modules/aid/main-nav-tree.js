    ...
    data:[
           ...
           data:[
               ...
               data: [
                   ...
                   { id:"1.3.2", value:"Mask",icon: '<span class="fa-solid fa-masks-theater" style="color: orange; width: 20px"></span>', },
                   { id:"1.3.3", value:"Init" ,icon: '<span class="fa-solid fa-x-ray" style="color: orange; width: 20px"></span>',},
               ] }
           ]},
